...
<head>
    ...
    <title>Tumbuhan - Zaydun</title>
    <link rel="icon" href="{{ asset('favicon.ico') }}" type="image/x-icon">
    <meta property="og:site_name" content="Zaydun">
    <meta property="og:type" content="website">
    <meta property="og:url" content="{{ url()->current() }}">
    <meta property="og:title" content="Tumbuhan - Zaydun">
    <meta property="og:description" content="Inspirasi & kebutuhan untuk tumbuhan kesayangan Anda. Panduan menanam, perawatan tanaman hias, dan produk berkebun.">
    ...
    <main class="flex-1 w-full">
        ...
        <div class="max-w-6xl mx-auto px-4 pt-6">
            <nav class="text-xs text-slate-500 flex items-center gap-1.5">
                ...
                <span class="text-emerald-700 font-semibold">🌱 Tumbuhan</span>
            </nav>
        </div>
        ...
        <section class="relative rounded-3xl overflow-hidden shadow-xl max-w-6xl mx-auto px-4 mt-4">
            ...
            <div class="relative z-10 py-14 px-6 text-center">
                ...
                <h1 class="text-3xl md:text-5xl font-black text-white mb-4 leading-tight max-w-3xl mx-auto">
                    Inspirasi & Kebutuhan untuk<br>Tumbuhan Kesayangan Anda
                </h1>
                <p class="text-emerald-100 text-base md:text-lg mb-8 max-w-2xl mx-auto leading-relaxed">
                    Temukan panduan tanam, perawatan, dan perlengkapan terbaik untuk tumbuhan. Dapatkan semuanya di satu tempat.
                </p>
                <a href="https://wa.me/6281234567890?text=Halo%20Admin%20Zaydun,%20saya%20ingin%20konsultasi%20seputar%20Tumbuhan" target="_blank" class="inline-flex items-center gap-2 bg-white text-emerald-700 font-bold text-sm px-7 py-3 rounded-full hover:bg-emerald-50 shadow-lg transition">
        ...
        <section class="max-w-6xl mx-auto px-4 mt-10 mb-8">
            <div class="bg-white rounded-3xl border border-slate-200 overflow-hidden shadow-sm p-8 md:p-10">
                <h2 class="text-2xl font-extrabold text-slate-800 mb-6 text-center">🌱 Tentang Tumbuhan di Zaydun</h2>
                ...
                <div class="grid grid-cols-1 md:grid-cols-{{ $admins->count() > 1 ? '2' : '1' }} gap-6 max-w-3xl mx-auto">
                    ...
                    <div class="flex flex-col md:flex-row items-center md:items-start gap-5 p-5 bg-emerald-50/50 rounded-2xl">
                        ...
                        <div class="flex-1 text-center md:text-left space-y-2">
                            ...
                            @endif
                            <div class="pt-1">
                                <a href="https://wa.me/{{ $admin->phone ?? '6281234567890' }}?text=Halo%20{{ urlencode($admin->name) }},%20saya%20ingin%20bertanya%20seputar%20Tumbuhan" target="_blank" class="inline-flex items-center gap-1.5 bg-emerald-500 hover:bg-emerald-600 text-white font-bold text-xs px-4 py-2 rounded-xl transition shadow-sm">
                                    💬 Chat {{ $admin->name }}
                                </a>
                            </div>
                        </div>
            ...
            @if($articles->count() > 0)
                <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                    @foreach($articles as $article)
                        <a href="{{ route('articles.show', $article->slug) }}" class="bg-white rounded-2xl border border-slate-200 overflow-hidden hover:border-emerald-400 hover:shadow-lg transition-all duration-300 group">
        ...
        <section class="max-w-6xl mx-auto px-4 mt-16 mb-8">
            <div class="relative rounded-3xl overflow-hidden shadow-xl">
                ...
                <div class="relative z-10 py-12 px-6 text-center">
                    ...
                    <a href="https://wa.me/6281234567890?text=Halo%20Admin%20Zaydun,%20saya%20ingin%20bertanya%20seputar%20Tumbuhan" target="_blank" class="inline-flex items-center gap-2 bg-white text-emerald-700 font-bold text-sm px-7 py-3 rounded-full hover:bg-emerald-50 shadow-lg transition">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-10 pb-10 border-b border-slate-800">
                ...
                <div>
                    ...
                    <ul class="space-y-2.5 text-xs">
                        ...
                        <li><a href="{{ route('kategori.ikan') }}" class="hover:text-emerald-400 transition">Ikan</a></li>
