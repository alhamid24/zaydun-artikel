...
<body class="bg-slate-50 text-gray-800 font-sans flex flex-col min-h-screen justify-between">
    ...
    <main class="flex-1 w-full">
        ...
        <section class="relative rounded-3xl overflow-hidden shadow-xl max-w-6xl mx-auto px-4 mt-4">
            ...
            <div class="relative z-10 py-14 px-6 text-center">
                ...
                <a href="https://wa.me/6281234567890?text=Halo%20Admin%20Zaydun,%20saya%20ingin%20konsultasi%20seputar%20Tumbuhan" target="_blank" class="z-btn inline-flex items-center gap-2 bg-white text-emerald-700 font-bold text-sm px-7 py-3 rounded-full hover:bg-emerald-50 shadow-lg transition active:scale-95">
    ...
    <footer class="bg-slate-900 mt-10 pt-14 pb-8 text-sm text-slate-400">
        <div class="h-1 bg-gradient-to-r from-emerald-600 via-teal-500 to-emerald-400"></div>
