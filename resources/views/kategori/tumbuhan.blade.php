        ...
        <section class="relative rounded-3xl overflow-hidden shadow-xl max-w-6xl mx-auto px-4 mt-4">
            ...
            <div class="relative z-10 py-14 px-6 text-center">
                <div class="inline-block bg-white/20 backdrop-blur-sm text-white text-xs font-bold px-4 py-1.5 rounded-full mb-5 uppercase tracking-widest">
                    <x-icon name="sprout" class="w-4 h-4 inline-block -mt-0.5 align-middle" /> Tumbuh-tumbuhan
                </div>
                ...
                <a href="https://wa.me/6281234567890?text=Halo%20Admin%20Zaydun,%20saya%20ingin%20konsultasi%20seputar%20Tumbuhan" target="_blank" class="z-btn inline-flex items-center gap-2 bg-white text-emerald-700 font-bold text-sm px-7 py-3 rounded-full hover:bg-emerald-50 shadow-lg transition">
        ...
        <section class="max-w-6xl mx-auto px-4 mt-16 mb-8 reveal">
            <div class="relative rounded-3xl overflow-hidden shadow-xl">
                ...
                <div class="relative z-10 py-12 px-6 text-center">
                    ...
                    <a href="https://wa.me/6281234567890?text=Halo%20Admin%20Zaydun,%20saya%20ingin%20bertanya%20seputar%20Tumbuhan" target="_blank" class="z-btn inline-flex items-center gap-2 bg-white text-emerald-700 font-bold text-sm px-7 py-3 rounded-full hover:bg-emerald-50 shadow-lg transition">
