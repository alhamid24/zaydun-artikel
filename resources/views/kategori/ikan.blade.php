    ...
    <main class="flex-1 w-full">
        ...
        <div class="max-w-6xl mx-auto px-4 pt-6">
            <nav class="text-xs text-slate-500 flex items-center gap-1.5">
                ...
                <span class="text-cyan-700 font-semibold inline-flex items-center gap-1.5"><x-icon name="fish" class="w-4 h-4 text-cyan-500" /> Ikan Cupang</span>
            </nav>
        </div>
        ...
        <section class="relative rounded-3xl overflow-hidden shadow-xl max-w-6xl mx-auto px-4 mt-4">
            ...
            <div class="relative z-10 py-14 px-6 text-center">
                ...
                <a href="https://wa.me/6281234567890?text=Halo%20Admin%20Zaydun,%20saya%20ingin%20konsultasi%20seputar%20Ikan%20Cupang" target="_blank" class="z-btn inline-flex items-center gap-2 bg-white text-cyan-700 font-bold text-sm px-7 py-3 rounded-full hover:bg-cyan-50 shadow-lg transition">
                    <x-icon name="wa" class="w-4 h-4 inline-block -mt-0.5 align-middle" /> Konsultasi via WhatsApp
                </a>
            </div>
        </section>
        ...
        <section class="max-w-6xl mx-auto px-4 mt-10 reveal">
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div class="z-card bg-white rounded-2xl border border-slate-200 p-5 text-center hover:shadow-md transition">
                    <div class="mb-2"><x-icon name="document-text" class="w-8 h-8 mx-auto text-cyan-500" /></div>
                ...
                <div class="z-card bg-white rounded-2xl border border-slate-200 p-5 text-center hover:shadow-md transition">
                    <div class="mb-2"><x-icon name="shopping-cart" class="w-8 h-8 mx-auto text-cyan-500" /></div>
                ...
                <div class="z-card bg-white rounded-2xl border border-slate-200 p-5 text-center hover:shadow-md transition">
                    <div class="mb-2"><x-icon name="clock" class="w-8 h-8 mx-auto text-cyan-500" /></div>
                    ...
                    <div x-show="open" x-transition:enter="transition ease-out duration-200" x-transition:enter-start="opacity-0 translate-y-1" x-transition:enter-end="opacity-100 translate-y-0" x-transition:leave="transition ease-in duration-150" x-transition:leave-start="opacity-100 translate-y-0" x-transition:leave-end="opacity-0 translate-y-1" class="absolute left-0 mt-2 w-56 bg-white border border-slate-200 rounded-2xl shadow-xl z-50 p-2 space-y-1" style="display: none;">
                        <div x-data="{ subOpen: false }" class="relative">
                            <button @click="subOpen = !subOpen" class="flex items-center justify-between w-full px-3 py-2.5 text-xs font-semibold text-slate-700 hover:bg-cyan-50 hover:text-cyan-600 rounded-xl transition">
                                <span class="inline-flex items-center gap-1.5"><x-icon name="fish" class="w-4 h-4 text-cyan-500" /> Budidaya</span>
                ...
                <div class="grid grid-cols-1 md:grid-cols-{{ $admins->count() > 1 ? '2' : '1' }} gap-6 max-w-3xl mx-auto">
                    ...
                    <div class="flex flex-col md:flex-row items-center md:items-start gap-5 p-5 bg-cyan-50/50 rounded-2xl">
                        ...
                        <div class="flex-1 text-center md:text-left space-y-2">
                            ...
                            @endif
                            <div class="pt-1">
                                <a href="https://wa.me/{{ $admin->phone ?? '6281234567890' }}?text=Halo%20{{ urlencode($admin->name) }},%20saya%20ingin%20bertanya%20seputar%20Ikan%20Cupang" target="_blank" class="z-btn inline-flex items-center gap-1.5 bg-emerald-500 hover:bg-emerald-600 text-white font-bold text-xs px-4 py-2 rounded-xl transition shadow-sm">
        ...
        <section class="max-w-6xl mx-auto px-4 mt-16 mb-8 reveal">
            <div class="relative rounded-3xl overflow-hidden shadow-xl">
                ...
                <div class="relative z-10 py-12 px-6 text-center">
                    ...
                    <a href="https://wa.me/6281234567890?text=Halo%20Admin%20Zaydun,%20saya%20ingin%20bertanya%20seputar%20Ikan%20Cupang" target="_blank" class="z-btn inline-flex items-center gap-2 bg-white text-cyan-700 font-bold text-sm px-7 py-3 rounded-full hover:bg-cyan-50 shadow-lg transition">
