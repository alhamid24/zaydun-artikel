...
<head>
    ...
    <title>Produk Ikan - Zaydun</title>
    <link rel="icon" href="{{ asset('favicon.ico') }}" type="image/x-icon">
    <meta property="og:site_name" content="Zaydun">
    <meta property="og:type" content="website">
    <meta property="og:url" content="{{ url()->current() }}">
    <meta property="og:title" content="Produk Ikan - Zaydun">
    <meta property="og:description" content="Koleksi produk ikan cupang berkualitas. Pesan langsung via WhatsApp.">
    ...
    <main class="flex-1 w-full">
        ...
        <div class="max-w-6xl mx-auto px-4 pt-6">
            <nav class="text-xs text-slate-500 flex items-center gap-1.5">
                ...
                <span class="text-cyan-700 font-semibold">🛒 Produk Ikan</span>
            </nav>
        </div>
        ...
        <section class="relative rounded-3xl overflow-hidden shadow-xl max-w-6xl mx-auto px-4 mt-4">
            ...
            <div class="relative z-10 py-12 px-6 text-center">
                ...
                <h1 class="text-3xl md:text-4xl font-black text-white mb-3 leading-tight">
                    Kebutuhan Lengkap untuk Cupang Kesayangan Anda
                </h1>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-10 pb-10 border-b border-slate-800">
                ...
                <div>
                    ...
                    <ul class="space-y-2.5 text-xs">
                        ...
                        <li><a href="{{ route('products.ikan') }}" class="hover:text-cyan-400 transition">Produk Ikan</a></li>
                        <li><a href="{{ route('products.tumbuhan') }}" class="hover:text-cyan-400 transition">Produk Tumbuhan</a></li>
