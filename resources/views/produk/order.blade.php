...
<body class="bg-slate-50 text-gray-800 font-sans flex flex-col min-h-screen">
    ...
    <main class="flex-1 w-full">
        ...
        <!-- FORM PEMESANAN -->
        <section class="max-w-3xl mx-auto px-4 mt-6 mb-12">
            <div class="bg-white rounded-3xl border border-slate-200 overflow-hidden shadow-sm">

                <!-- Ringkasan Produk -->
                <div class="flex gap-4 p-6 border-b border-slate-100 bg-slate-50">
                    <img src="{{ asset('uploads/products/'.$product->image) }}" alt="{{ $product->name }}" class="w-16 h-16 object-cover rounded-xl shrink-0">
                ...
                <div class="p-6 md:p-8 space-y-6">
                    ...
                    <!-- Tombol Kirim -->
                    <div class="pt-4">
                        <button onclick="kirimPesan()" class="w-full bg-emerald-500 hover:bg-emerald-600 text-white font-bold text-sm px-8 py-4 rounded-xl transition shadow-sm flex items-center justify-center gap-2">
