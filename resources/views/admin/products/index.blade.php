        ...
        <table class="w-full text-left border-collapse">
            ...
            <tbody>
                ...
                <tr class="border-b border-gray-100 hover:bg-gray-50 text-sm transition">
                    <td class="p-4">
                        <img src="{{ asset('uploads/products/'.$product->image) }}" class="w-12 h-12 object-cover rounded-lg">
                    </td>
                ...
                @empty
                <tr>
                    <td colspan="6" class="p-8 text-center text-gray-400 italic">Belum ada produk. Yuk tambah baru!</td>
                </tr>
                @endforelse
            </tbody>
        </table>
