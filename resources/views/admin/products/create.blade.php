...
<div class="max-w-3xl bg-white p-8 rounded-2xl shadow-sm border border-gray-200">
    ...
    <form action="{{ url('admin/products/'.$category_slug) }}" method="POST" enctype="multipart/form-data" class="space-y-6">
        ...
        <div>
            ...
            <input type="text" name="whatsapp_number" value="{{ old('whatsapp_number', default_wa_number()) }}" placeholder="62812xxxxxxx" class="w-full px-4 py-2.5 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-emerald-500" required>
