...
<div class="bg-white p-6 rounded-2xl shadow-sm border border-gray-200 max-w-2xl">
    <div class="flex items-center justify-between mb-6">
        ...
        <a href="{{ route('admin.reviews.index', ['kategori' => request('kategori', 'semua')]) }}" class="text-gray-500 hover:text-gray-700 font-semibold text-sm transition">
            <svg class="w-3.5 h-3.5 inline-block -mt-0.5 align-middle" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 19l-7-7m0 0l7-7m-7 7h18"/></svg> Kembali
        </a>
    </div>

    @if($errors->any())
        <div class="flex items-start gap-2.5 bg-red-50 border border-red-200 text-red-700 p-3.5 rounded-xl mb-4 text-sm">
